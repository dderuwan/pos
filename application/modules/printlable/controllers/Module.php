...
class Module extends MX_Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = display('printlable');
        $data['module'] = "printlable";
    ...
    public function all_product_list(){
        ...
        $product_info = $this->addons_model->product_search_item($product_name);
    ...
    public function get_product_price(){
        ...
        $details = $this->db->select('*')->from('product_information')->where(['product_id ' => $product_id ])->get()->result();
        if (!empty($details)) {
        ...
        // $data['product_info'] = $this->addons_model->product_search_price($product_id);
    ...
    public function print()
    {
        ...
        $data['exdate'] = $this->input->post('exdate');
        $data['mdate'] = $this->input->post('mdate');
        $data['count'] = $this->input->post('count');
        $data['unit'] = $this->input->post('unit');
        $view  = $this->load->view('printlable/lable',$data,true);
        echo $view;exit; 
      
        // $data['module'] = "printlable";
        // $data['page'] = "module/barcode";
        // echo Modules::run('template/layout', $data);
    }
