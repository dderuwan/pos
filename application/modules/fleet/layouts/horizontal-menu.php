        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="/Dason-PHP" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="assets/images/logo-sm.svg" alt="" height="24"> <span class="logo-txt">New Shaheen LLC
                        </span>
                    </span>
                </a>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle arrow-none" href="/Dason-PHP" id="topnav-dashboard"
                            role="button">
                            <i data-feather="home"></i><span data-key="t-dashboard">
                                                ...
                                                <div class="col-lg-5">
                                                    <div>
                                                        <a href="ui-alerts.php" class="dropdown-item"
                                                            data-key="t-alerts">
                                                            <?php echo $language['Alerts'] ?>
                                                        </a>
                                                        <a href="ui-buttons.php" class="dropdown-item"
                                                            data-key="t-buttons">
                                                            <?php echo $language['Buttons'] ?>
                                                        </a>
                                                        <a href="ui-cards.php" class="dropdown-item" data-key="t-cards">
                                                            <?php echo $language['Cards'] ?>
                                                        </a>
                                                        <a href="ui-carousel.php" class="dropdown-item"
                                                            data-key="t-carousel">
                                                            <?php echo $language['Carousel'] ?>
                                                        </a>
                                                        <a href="ui-dropdowns.php" class="dropdown-item"
                                                            data-key="t-dropdowns">
                                                            <?php echo $language['Dropdowns'] ?>
                                                        </a>
                                                        <a href="ui-grid.php" class="dropdown-item" data-key="t-grid">
                                                            <?php echo $language['Grid'] ?>
                                                        </a>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-ecommerce"
                                    ...
                                    <span data-key="t-ecommerce">
                                        <?php echo $language['Ecommerce'] ?>
                                    </span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">

                                    <a href="ecommerce-products.php" class="dropdown-item" data-key="t-products">
                                        <?php echo $language['Products'] ?>
                                    </a>
                                    <a href="ecommerce-product-detail.php" class="dropdown-item"
                                        data-key="t-product-detail">
                                        <?php echo $language['Product_Detail'] ?>
                                    </a>
                                    <a href="ecommerce-orders.php" class="dropdown-item" data-key="t-orders">
                                        <?php echo $language['Orders'] ?>
                                    </a>
                                    <a href="ecommerce-customers.php" class="dropdown-item" data-key="t-customers">
                                        <?php echo $language['Customers'] ?>
                                    </a>
                                    <a href="ecommerce-cart.php" class="dropdown-item" data-key="t-cart">
                                        <?php echo $language['Cart'] ?>
                                    </a>
                                    <a href="ecommerce-checkout.php" class="dropdown-item" data-key="t-checkout">
                                        <?php echo $language['Checkout'] ?>
                                    </a>
                                    <a href="ecommerce-shops.php" class="dropdown-item" data-key="t-shops">
                                        <?php echo $language['Shops'] ?>
                                    </a>
                                    <a href="ecommerce-add-product.php" class="dropdown-item" data-key="t-add-product">
                                        <?php echo $language['Add_Product'] ?>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-tasks">
                                    <a href="tasks-list.php" class="dropdown-item" data-key="t-task-list">
                                        <?php echo $language['Task_List'] ?>
                                    </a>
                                    <a href="tasks-kanban.php" class="dropdown-item" data-key="t-kanban-board">
                                        <?php echo $language['Kanban_Board'] ?>
                                    </a>
                                    <a href="tasks-create.php" class="dropdown-item" data-key="t-create-task">
                                        <?php echo $language['Create_Task'] ?>
                                    </a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-contact"
                                    ...
                                    <span data-key="t-contacts">
                                        <?php echo $language['Contacts'] ?>
                                    </span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                    <a href="apps-contacts-grid.php" class="dropdown-item" data-key="t-user-grid">
                                        <?php echo $language['User_Grid'] ?>
                                    </a>
                                    <a href="apps-contacts-list.php" class="dropdown-item" data-key="t-user-list">
                                        <?php echo $language['User_List'] ?>
                                    </a>
                                    <a href="apps-contacts-profile.php" class="dropdown-item" data-key="t-profile">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-form">
                                    <a href="form-elements.php" class="dropdown-item" data-key="t-form-elements">
                                        <?php echo $language['Basic_Elements'] ?>
                                    </a>
                                    <a href="form-validation.php" class="dropdown-item" data-key="t-form-validation">
                                        <?php echo $language['Validation'] ?>
                                    </a>
                                    <a href="form-advanced.php" class="dropdown-item" data-key="t-form-advanced">
                                        <?php echo $language['Advanced_Plugins'] ?>
                                    </a>
                                    <a href="form-editors.php" class="dropdown-item" data-key="t-form-editors">
                                        <?php echo $language['Editors'] ?>
                                    </a>
                            ...
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-table"
                                    ...
                                    <span data-key="t-tables">
                                        <?php echo $language['Tables'] ?>
                                    </span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-table">
                                    <a href="tables-basic.php" class="dropdown-item" data-key="t-basic-tables">
                                        <?php echo $language['Bootstrap_Basic'] ?>
                                    </a>
                                    <a href="tables-datatable.php" class="dropdown-item" data-key="t-data-tables">
                                        <?php echo $language['DataTables'] ?>
                                    </a>
                                    <a href="tables-responsive.php" class="dropdown-item" data-key="t-responsive-table">
                                        <?php echo $language['Responsive'] ?>
                                    </a>
                                    <a href="tables-editable.php" class="dropdown-item" data-key="t-editable-table">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-charts"
                                    ...
                                    <span data-key="t-charts">
                                        <?php echo $language['Charts'] ?>
                                    </span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                    <a href="charts-apex.php" class="dropdown-item" data-key="t-apex-charts">
                                        <?php echo $language['Apexcharts'] ?>
                                    </a>
                                    <a href="charts-echart.php" class="dropdown-item" data-key="t-e-charts">
                                        <?php echo $language['Echarts'] ?>
                                    </a>
                                    <a href="charts-chartjs.php" class="dropdown-item" data-key="t-chartjs-charts">
                                        <?php echo $language['Chartjs'] ?>
                                    </a>
                                    <a href="charts-knob.php" class="dropdown-item" data-key="t-knob-charts">
                                        <?php echo $language['Jquery_Knob'] ?>
                                    </a>
                                    <a href="charts-sparkline.php" class="dropdown-item" data-key="t-sparkline-charts">
                                        <?php echo $language['Sparkline'] ?>
                                    </a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                    <a href="icons-feather.php" class="dropdown-item" data-key="t-feather">
                                        <?php echo $language['Feather'] ?>
                                    </a>
                                    <a href="icons-boxicons.php" class="dropdown-item" data-key="t-boxicons">
                                        <?php echo $language['Boxicons'] ?>
                                    </a>
                                    <a href="icons-materialdesign.php" class="dropdown-item"
                                        data-key="t-material-design">
                                        <?php echo $language['Material_Design'] ?>
                                    </a>
                                    <a href="icons-dripicons.php" class="dropdown-item" data-key="t-dripicons">
                                        <?php echo $language['Dripicons'] ?>
                                    </a>
                                    <a href="icons-fontawesome.php" class="dropdown-item" data-key="t-font-awesome">
                                        <?php echo $language['Font_Awesome_5'] ?>
                                    </a>
                                </div>
                            </div>
                            <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-more">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                    <a href="auth-login.php" class="dropdown-item" data-key="t-login">
                                        <?php echo $language['Login'] ?>
                                    </a>
                                    <a href="auth-register.php" class="dropdown-item" data-key="t-register">
                                        <?php echo $language['Register'] ?>
                                    </a>
                                    <a href="auth-recoverpw.php" class="dropdown-item" data-key="t-recover-password">
                                        <?php echo $language['Recover_Password'] ?>
                                    </a>
                                    <a href="auth-lock-screen.php" class="dropdown-item" data-key="t-lock-screen">
                                        <?php echo $language['Lock_Screen'] ?>
                                    </a>
                                    <a href="auth-Logout.php" class="dropdown-item" data-key="t-Logout">
                                        <?php echo $language['Logout'] ?>
                                    </a>
                                    <a href="auth-confirm-mail.php" class="dropdown-item" data-key="t-confirm-mail">
                                        <?php echo $language['Confirm_Mail'] ?>
                                    </a>
                                    <a href="auth-email-verification.php" class="dropdown-item"
                                        data-key="t-email-verification">
                                        <?php echo $language['Email_Verification'] ?>
                                    </a>
                                    <a href="auth-two-step-verification.php" class="dropdown-item"
                                        data-key="t-two-step-verification">
                                        <?php echo $language['Two_Step_Verification'] ?>
                                    </a>
                                </div>
                            </div>
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-utility"
                                    ...
                                    <span data-key="t-utility">
                                        <?php echo $language['Utility'] ?>
                                    </span>
                                    <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-utility">
                                    <a href="pages-starter.php" class="dropdown-item" data-key="t-starter-page">
                                        <?php echo $language['Starter_Page'] ?>
                                    </a>
                                    <a href="pages-maintenance.php" class="dropdown-item" data-key="t-maintenance">
                                        <?php echo $language['Maintenance'] ?>
                                    </a>
                                    <a href="pages-comingsoon.php" class="dropdown-item" data-key="t-coming-soon">
                                        <?php echo $language['Coming_Soon'] ?>
                                    </a>
                                    <a href="pages-timeline.php" class="dropdown-item" data-key="t-timeline">
                                        <?php echo $language['Timeline'] ?>
                                    </a>
                                    <a href="pages-faqs.php" class="dropdown-item" data-key="t-faqs">
                                        <?php echo $language['FAQs'] ?>
                                    </a>
