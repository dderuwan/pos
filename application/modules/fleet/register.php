...
<head>
    ...
    <title>
        <?php echo $language["Register"]; ?> | New Shaheen LLC - Admin & Dashboard Template
    </title>
                        ...
                        <div class="d-flex flex-column h-100">
                            ...
                            <div class="auth-content my-auto">
                                <div class="text-center">
                                    ...
                                    <p class="text-muted mt-2">Get your New Shaheen LLC account now.</p>
                                </div>
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">©
                                    ...
                                    </script> NewShaheenLLC . Crafted with <i class="mdi mdi-heart text-danger"></i> by
                                    Esupport
                                </p>
                            </div>
                        </div>
