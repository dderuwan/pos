...
<head>
    ...
    <title>
        <?php echo $language["Logout"]; ?> | FNew Shaheen LLC - Admin & Dashboard
    </title>
                    ...
                    <div class="w-100">
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                ...
                                <span class="logo-txt">New Shaheen LLC Logistic</span>
                            </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <div class="mt-4 pt-2">
                                        ...
                                        <p class="text-muted font-size-15">Thank you for using <span
                                                class="fw-semibold text-dark">New Shaheen LLC Logistic</span></p>
                                        <div class="mt-4">
                                            <a href="login.php"
                            ...
                            <div class="mt-4 mt-md-5 text-center">
                                <p class="mb-0">©
                                    ...
                                    </script> New Shaheen LLC . Crafted with <i class="mdi mdi-heart text-danger"></i>
                                    by
                                    Esupport
                                </p>
                            </div>
