...
if (isset($_GET['delete_id'])) {
    ...
    $deleteQuery = "DELETE FROM customers WHERE phonenumber = '$deleteId'";
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-md-end align-items-center">
                                        <a class="btn btn-sm btn-default btn-flat border-primaryy"
                                            style="border-color: #2ecc71;" href="./customer-add.php"><i
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo '<th scope="row">' . $row['customername'] . '</th>';
                                            echo '<td>' . $row['address'] . '</td>';
                                            echo '<td>' . $row['phonenumber'] . '</td>';
                                            echo '<td>
           
                                       <a href="customer-update.php?phonenumber=' . $row['phonenumber'] . '" class="btn btn-green btn-sm" style="background-color:#3498db;color:white">

                                          <i class="fas fa-edit"></i> Edit
                                        </a>
                                        <a href="?delete_id=' . $row['phonenumber'] . '" class="btn btn-danger btn-sm">
                ...
                <script>
                    $(document).ready(function () {
                        ...
                        $('.btn-view').on('click', function () {
                            ...
                            var url =
                                'http://localhost/Flotilla-logistic/assets/BILL OF DELIVERY ORDER/' +
