...
$query = "SELECT * FROM manifest_invoice";
...
if (isset($_GET['delete_id'])) {
    ...
    $deleteQuery = "DELETE FROM manifest_invoice WHERE manifest_id = '$deleteId'";
    if (mysqli_query($link, $deleteQuery)) {
        // Redirect back to the main page after successful deletion
        header("Location:import-list-manifest-invoice.php");
        exit();
    } else {
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-md-end align-items-center">
                                        <a class="btn btn-sm btn-default btn-flat border-primaryy"
                                            style="border-color: #2ecc71;" href="./import-new-form.php"><i
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo '<th scope="row">' . $row['manifest_id'] . '</th>';
                                            echo '<td>' . $row['generator_id'] . '</td>';
                                            echo '<td>
            <a href="#" class="btn btn-success btn-sm btn-view"
                                                    data-id="' . htmlspecialchars($row['manifest_id']) . '">
                                                    <i class="fas fa-eye"></i> View
                                                </a>
    <a href="#" class="btn btn-sm btn-print" data-id="' . htmlspecialchars($row['manifest_id']) . '"
                                style="background-color:#3498db;color:white">
                                <i class="fas fa-print"></i> Print
                            </a>
            <a href="?delete_id=' . $row['manifest_id'] . '" class="btn btn-danger btn-sm">
            <i class="fas fa-trash" ></i> Delete
                ...
                <div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel"
                    aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 1230px;">
                        <div class="modal-content" style="max-width: 1230px;">
                ...
                <script>
                    $(document).ready(function () {
                        ...
                        $('.btn-view').on('click', function () {
                            ...
                            var url =
                                'https://system.Flotillalogistics.com/assets/BILL OF MEIFEST/' +
                                encodeURIComponent(Number) + '.html';
