...
$query = "SELECT * FROM creadit_invoice";
...
if (isset($_GET['delete_id'])) {
    ...
    $deleteQuery = "DELETE FROM creadit_invoice WHERE invoiceNum = '$deleteId'";
...
<head>
    ...
    <title>
        <?php echo $language["DataTables"]; ?> | Flotilla - Admin & Dashboard
    </title>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6 d-flex justify-content-md-end align-items-center">
                                        <a class="btn btn-sm btn-default btn-flat border-primaryy"
                                            style="border-color: #2ecc71;" href="./credit-invoice.php"><i
                ...
                <script>
                    $(document).ready(function () {
                        ...
                        $('.btn-view').on('click', function () {
                            ...
                            var url =
                                'https://system.Flotillalogistics.com/assets/BILL%20OF%20CREDIT%20INVOCE/' +
