...
if (isset($_GET['delete_id'])) {
    ...
    $deleteQuery = "DELETE FROM shippers WHERE id = '$deleteId'";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $updateQuery = "UPDATE shippers SET shippername = ?, address = ?, phone_number = ?WHERE id = ?";
    $stmt = mysqli_prepare($link, $updateQuery);
    mysqli_stmt_bind_param($stmt, 'sssi', $shippername, $address, $phonenumber,$id);
                                    ...
                                    <table class="table table-editable table-nowrap align-middle table-edits">
                                        ...
                                        <tbody>
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo '<td data-field="shippername">' . $row['shippername'] . '</td>';
