...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO vendor(vendorname, address, phonenumber) VALUES (?, ?, ?)";
    $stmt = $link->prepare($query);
    $stmt->bind_param("sss", $vendorname, $address, $phonenumber);
...
<html>
<head>
    <title>Create Customer | New Shaheen LLC - Admin & Dashboard</title>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="card-title mb-4">Add New Vendor</h4>
                                    <form method="post">
                                        <div class="form-group row mb-4">
                                            <label for="vendorname" class="col-form-label col-lg-2">Vendor Name</label>
                                            <div class="col-lg-10">
