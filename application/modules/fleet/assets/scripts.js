...
//   return array;
// }
// // Function to make an AJAX request to fetch the total data from the database
// // function fetchRowCount() {
// //   $.ajax({
// //       url: 'getRowCount.php', // Replace with the correct URL to fetch the row count
// //       dataType: 'json',
// //       success: function (data) {
// //           // Assuming the row count is returned as 'rowCount' in the JSON response
// //           var rowCount = data.rowCount;

// //           // Update the chart configuration
// //           spark1.title.text = 'Total Rows: ' + rowCount; // Assign the fetched row count to the title

// //           // Create the chart with updated configuration
...
// // // Call the fetchRowCount function to update the chart title
// // fetchRowCount();
