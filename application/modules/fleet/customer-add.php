...
<html>
<head>
    <title>Create Customer | Dason - Admin & Dashboard Template</title>
                                ...
                                <div class="card-body">
                                    ...
                                    <form method="post">
                                        <div class="form-group row mb-4">
                                            <label for="customername" class="col-form-label col-lg-2">Customer Name</label>
                                            <div class="col-lg-10">
                                                <input id="customername" name="customername" type="text" class="form-control" placeholder="Enter Customer Name...">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
