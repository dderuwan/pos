...
if (isset($_GET['delete_id'])) {
    ...
    $deleteQuery = "DELETE FROM delivery_order WHERE agent_do_no = '$deleteId'";
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive  nowrap w-100">
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo '<th scope="row">' . $row['agent_do_no'] . '</th>';
                                            echo '<td>' . $row['serial_no'] . '</td>';
                                            echo '<td>' . $row['consignee_name_address'] . '</td>';
                                            echo '<td>
            <a href="#" class="btn btn-success btn-sm btn-view"
                                                    data-id="' . htmlspecialchars($row['agent_do_no']) . '">
                                                    <i class="fas fa-eye"></i> View
                                                </a>
    <a href="#" class="btn btn-sm btn-print" data-id="' . htmlspecialchars($row['agent_do_no']) . '"
                                style="background-color:#3498db;color:white">
                                <i class="fas fa-print"></i> Print
                            </a>
            <a href="?delete_id=' . $row['agent_do_no'] . '" class="btn btn-danger btn-sm">
                ...
                <script>
                    $(document).ready(function () {
                        ...
                        $('.btn-view').on('click', function () {
                            ...
                            var url =
                                'https://system.Flotillalogistics.com/assets/BILL OF DELIVERY ORDER/' +
