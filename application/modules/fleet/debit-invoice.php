...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Define the location
    $location = "https://system.Flotillalogistics.com/assets/BILL OF DEBIT INVOCE/$invoiceNum.html";

    // Prepare and execute SQL query to insert data
    $query = "INSERT INTO debit_invoice(invoiceNum,companyName,location) VALUES (?,?,?)";
                                        ...
                                        <td colspan="2">
                                            <div class="logo1">
                                                ...
                                                <label for="" style="font-size:10px;line-height: 12px;color:blue">167,
                                                    ...
                                                    info@NewShaheenLLC logistics.com Web:
 ...
 <head>
  <title>Print Invoice</title>
         ...
         <table>
                                ...
                                <tr>
                                    <td colspan="5">
                                        ...
                                        <div class="td-div">
                                            <span> Date:</span><input id="dateInvoice" name="dateInvoice" type="date" placeholder="${dateInvoice}">
                                ...
                                <tr>
                                    <td colspan="3">
                                        ...
                                        <div class="td-div">
                                            <span>Street Address</span> <input type="textArea" id="strAddress" placeholder="${strAddress}""
                                                name="strAddress">
                                        </div>
                                        <div class="td-div">
    ...
    `;
                            ...
                            $.ajax({
                                type: 'POST',
                                url: 'save_printed_content_debit_invoice.php', // Update with the correct PHP script path
                                data: {
